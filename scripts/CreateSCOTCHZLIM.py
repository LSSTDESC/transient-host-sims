...
GID_df.to_csv("/global/cscratch1/sd/agaglian/SCOTCH_GIDs_ZLIM.tar.gz",index=False)
...
transDir = "/global/cscratch1/sd/kessler/SNANA_LSST_SIM/SCOTCH_ZLIM/"
prefix = "MLAG_GP_SCOTCH_ZLIM"
...
# make the HDF5 file
f    = h5py.File("/global/cscratch1/sd/agaglian/scotch_zlim.hdf5", "a")
