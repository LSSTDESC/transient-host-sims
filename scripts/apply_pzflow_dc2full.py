...
quantities = ['galaxy_id', 'redshift', 'Mag_true_g_sdss_z0', 'Mag_true_r_sdss_z0', 'Mag_true_i_sdss_z0', 'Mag_true_z_sdss_z0',
              'morphology/totalSersicIndex', 'morphology/totalEllipticity', 'stellar_mass', 'totalStarFormationRate']
...
data_unscaled['morphology/totalSersicIndex'] = np.concatenate(sersic)
...
subsamp = np.random.choice(np.arange(len(samples['logmass'])), size=50000, replace=False)
