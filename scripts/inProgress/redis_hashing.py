...
print("Test test this is working")
...
config = redis_storage.load_hash_configuration('cosmoMatching')
...
if config is None:
    ...
    print("Loading hash configuration!")
...
#note that this only needs to be done once, so after the first run it should be 
